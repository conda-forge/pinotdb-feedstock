...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pinotdb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11999&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pinotdb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pinotdb` can be installed with:

```
conda install pinotdb
```

It is possible to list all of the versions of `pinotdb` available on your platform with:
